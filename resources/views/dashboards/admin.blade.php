...
<div class="mx-auto max-w-7xl space-y-8 px-4 py-6 sm:px-6 lg:px-8">
    ...
    <section class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-700 via-blue-600 to-slate-900 p-8 shadow-xl shadow-blue-900/20 sm:p-10">
        ...
        <div class="relative">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                <a href="{{ route('admin.documents.import') }}" class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-900/30 transition hover:from-blue-700 hover:to-sky-700">
    ...
    <section class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:col-span-2">
            <p class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-blue-600 dark:text-sky-400">
                <span class="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-blue-400 to-sky-600 text-white shadow-lg shadow-blue-500/30">
