...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/metamedia.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/metamedia.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('assets/metamedia.png') }}">
