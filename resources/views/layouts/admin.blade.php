...
<body class="admin-body">
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-menu">
            ...
            <a class="{{ request()->routeIs('admin.data.mahasiswa') ? 'active' : '' }}" href="{{ route('admin.data.mahasiswa') }}">
            ...
            <a class="{{ request()->routeIs('admin.data.dosen') ? 'active' : '' }}" href="{{ route('admin.data.dosen') }}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></svg>
            ...
            <a class="{{ request()->routeIs('admin.documents.pending') ? 'active' : '' }}" href="{{ route('admin.documents.pending') }}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/></svg>
                <span>Verifikasi Upload</span>
            </a>
            <a class="{{ request()->routeIs('admin.documents.index') ? 'active' : '' }}" href="{{ route('admin.documents.index') }}">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
                <span>Kelola Upload</span>
            </a>
            <a class="{{ request()->routeIs('admin.documents.import*') ? 'active' : '' }}" href="{{ route('admin.documents.import') }}">
            ...
            <a class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}#setting-upload">
